                    ...
                    <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
                        <div className="text-center">
                            <p className="text-xs font-semibold text-gray-500 tracking-wide uppercase mb-3 dark:text-gray-200">
                                Mauzodata sales Innovations
                            </p>
                            <h1 className="text-3xl text-gray-800 font-bold sm:text-4xl lg:text-5xl lg:leading-tight dark:text-gray-200">
                                Hello!,{" "}
                                <span className="text-cyan-500">
                                    This project is actively under maintainance.
                                </span>
                            </h1>
                        </div>
                        ...
                        <div className="sm:flex sm:justify-center sm:items-center text-center sm:text-start">
                            <div className="shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5">
                                <div className="flex justify-center -space-x-3">
                                    <span className="inline-flex items-center justify-center size-8 rounded-full ring-2 ring-white bg-gray-800 dark:bg-gray-900 dark:ring-gray-900">
                        ...
                        <div className="text-sm text-center text-balance text-gray-500 dark:text-gray-500">
                            Mauzodata is the best sales software for your
                            business, we help you to control your business just
                            on you hand and make your business more profitable.
                        </div>

                        <div>
                            <div className="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-gray-900 dark:border-gray-700 dark:shadow-gray-900/20">
                                <div className="whitespace-nowrap pt-2 sm:pt-0 grid sm:block">
                                    <Link
                                        className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-3xl border border-transparent bg-cyan-600 text-white hover:bg-cyan-700 focus:outline-none focus:bg-cyan-700 disabled:opacity-50 disabled:pointer-events-none"
                                        href={route("dashboard")}
                                    >
                                        I have early access to Mauzodata
                                    </Link>
                                </div>
                            </div>
                        </div>
